...
st.success('Current vaccination slot availability for Delhi NCR region using public CoWIN APIs [for today + 5 days]. Please use CoWIN site to book your vaccination slot')
